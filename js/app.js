(() => {
    ...
    let btnReadmores = document.querySelectorAll(".work_btn");
    if (btnReadmores) btnReadmores.forEach((btnReadmore => {
        btnReadmore.addEventListener("click", (function(e) {
            e.preventDefault();
            btnReadmore.parentElement.classList.toggle("show");
            btnReadmore.parentElement.parentElement.classList.toggle("show");
            btnReadmore.classList.toggle("show");
        }));
    }));
    let fullscreenImgs = document.querySelectorAll(".fullscreen_img");
    if (fullscreenImgs) fullscreenImgs.forEach((fullscreenImg => {
        fullscreenImg.addEventListener("click", (function() {
            fullscreenImg.parentElement.classList.toggle("showimg");
        }));
    }));
    window["FLS"] = false;
    menuInit();
